...
<ul>
<li><p><b>Додавання/віднімання</b>. Потрібно рокрити дужки та звести подібні доданки. Якщо перед дужками стоїть знак $$"$$+$$"$$, то знаки дужок лишаються незмінними; якщо  $$"$$-$$"$$, то знаки всередині дужок слід замінити на протилежні.</p></li>
<div class="space"></div>
