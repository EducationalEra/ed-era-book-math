...
<li>Нерівність є нестрогою, інтервали включають кінцеві точки, тому їх зображуємо зафарбованими Точка $$x=2$$ має кратність «$$2$$» - малюємо одну «пелюстку» на числовій вісі. Точка $$x=-3$$ має кратність «$$3$$»  - малюємо дві «пелюстки»:</li>
<><>
</ol>
<b>Вiдповiдь.</b> Отже, $$x \in (-\infty;-3) \cup (-2;2)$$.
</div>
