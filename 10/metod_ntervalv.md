...
<ol>
<p><b>Вiдповiдь.</b> $$x \in (-4;-2) \cup (2;\infty).$$</p>
</div>
</div>
</div>
...
<span class="task">Приклад</span>
<div class="task-text">
Розв’язати нерівність $$(x-2)(x+2)(3-x)<0$$. 
<p><b><i>Розв’язок</i></b>.</p>
<p>Многочлен в лівій частині $$P(x)=(x-2)(x+2)(3-x)$$ вже розкладений на множники, переходимо до п.$$3$$ алгоритму метода інтервалів.</p>
...
<p><b><i>Розв’язок</i></b>.</p>
<p>Многочлен в лівій частині $$P(x)=(x-1) (x-2)^2 (x+3)^3$$ вже розкладений на множники, переходимо до п.$$3$$ алгоритму метода інтервалів.</p> 
<ol start="3">
...
<p>Нерівність є нестрогою, інтервали включають кінцеві точки, тому їх зображуємо зафарбованими Точка $$x=2$$ має кратність «$$2$$» - малюємо одну «пелюстку» на числовій вісі. Точка $$x=-3$$ має кратність «$$3$$» - малюємо дві «пелюстки»:</p>
<li>Шукаємо знак функції на правому інтервалі $$(2;\infty)$$. Підставимо тестове значення «<font color="#0F5180"><i>мільярд</i></font>».</li>
<div class="space"><p align="center"><img align="middle" width="70%" height="70%" class="image" src="../pics/142/p24_e4.png"/></p></div>
<p>Всі три множники додатні, функція на цьому інтервалі має додатній знак:</p>
