...
<li>Обрати ті інтервали, на яких знаки $$P(x)$$ задовольняють вихідну нерівность.</li>
</ol>
</div>
</div>
</div>
...
<p><b><i>Розв’язок</i></b>.</p>
<p>Многочлен в лівій частині $$P(x)=(x-2)(x+2)(3-x)$$ вже розкладений на множники, переходимо до п.$$3$$ алгоритму методу інтервалів.</p>
...
<quiz correctLabel="correct" incorrectLabel="incorrect" checkLabel="check">
 <question text="">
        ...
        <p>Обираємо інтервали, де функція додатня: $$(-3;-1), (2;\infty)$$</p>
        </explanation>
</question>
</quiz>