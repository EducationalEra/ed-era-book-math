...
<p>Точно так само, як і для рівнянь з параметрами, основна концепція при розв’язанні нерівностей з параметрами полягає у наступному:</p>

<ol>
<li>Знайти «контрольнi» значення параметрiв, при яких у нерівності вiдбуваються якiснi змiни, наприклад, зміна знаку на протилежний.</li>
...
<p>Для того, аби зобразити ці точки на числовій прямій розглядаємо два випадки: </p>
<ul>
...
<ul>
<li>$$a>0$$: підставляємо тестове значення з правого інтервалу $$\left(\dfrac{3}{a};\infty \right)$$ - «\textit{\color{EdErablue}мільярд}»</li>
...
<li>$$a<0$$: підставляємо тестове значення з правого інтервалу $$(-a;\infty)$$ - «\textit{\color{EdErablue}мільярд}»</li>
