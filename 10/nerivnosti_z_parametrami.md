...
<td>$$
    ...
    \end{align}$$</td>
<td><font color="1570bd"><i>Вихідна нерівність<br><br>Множимо обидві частини на $$3$$<br>Спрощуємо<br>Віднімаємо $$3$$ від обох частин<br>Спрощуємо<br>Знаходимо квадратні корені обох частин<br>Спрощуємо<br>Записуємо розв'язок у інтервальному вигляді</i></font></td>
</tr>
</table>
