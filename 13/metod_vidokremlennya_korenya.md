...
Спочатку першу: $$5-4x+x^2\geq0.$$ Знайдемо дискримінант квадратного рівняння: $$D=(-4)^2-4⋅5⋅1=16-20=-4<0.$$ Дискримінант від’ємни – рівняння не має коренів. З урахуванням того, що коефіцієнт при $$x^2$$ додатний, ця нерівність справджуватиметься завжди.
