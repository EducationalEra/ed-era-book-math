...
3x-2\leq9(2x-1)^2.
\end{cases}$$</p>
Розглянемо кожну з нерівностей окремо, а потім знайдемо перетин їхніх розв’язків. Перша нерівність системи перетворюється на x≥2/3. Розглянемо окремо другу і третю нерівності:
