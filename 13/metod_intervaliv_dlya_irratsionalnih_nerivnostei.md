...
<li>
Шукаємо знак функції на правому інтервалі $$\left(\dfrac{14}{5};3\right].$$ Нашим улюбленим «мільярдом» вже користуватись не можна (не входить в ОДЗ), візьмемо якусь точку з інтервалу, наприклад $$\dfrac{29}{10}.$$
