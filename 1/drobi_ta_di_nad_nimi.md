...
<div class="space"><b>Основна властивiсть дробу</b>: якщо і чисельник, i знаменник помножити чи подiлити на одне й те саме число, відмінне від нуля, отримаємо дрiб, що рiвний вихiдному.</div>
...
* Множення. Добутком двох дробів є дріб, у чисельнику якого стоїть добуток чисельників цих дробів, а у знаменнику – добуток знаменників: $$\dfrac{a}{c}\cdot \dfrac{b}{d}=\dfrac{a\cdot b}{c\cdot c}.$$
