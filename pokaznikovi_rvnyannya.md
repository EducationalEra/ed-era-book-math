...
<tr>
<td><i class="expl">$$log_{2}$$</i>$$2^{4𝑥−3} = log_{2}5^{x}$$</td>
<td><i class="expl">Логарифмуємо обидві частини за основою $$2$$</i></td>
</tr>
<tr>
<td>$$(4𝑥−3)log_{2} 2 =x log_{2}5$$</td>
...
<td><i class="expl">Ділимо обидві частини на $$4𝑥- xlog^{2}5$$</i></td>
</tr>
</table>
</div>
</div>
