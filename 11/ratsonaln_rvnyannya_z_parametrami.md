...
<p>$$\dfrac{x+5}{ax+2}-{ax+4}{1-x}=0$$
$$\dfrac{1-x}{1-x}\cdot{x+5}{ax+2}-{ax+2}{ax+2}\cdot{ax+4}{1-x}=0$$
$$\dfrac{(1-x)(x+5)+(ax+2)(ax-4)}{(ax+2)(1-x)}=0$$
$$\dfrac{x+5-x^2-5x+(ax)^2-4ax+2ax-8}{(ax+2)(1-x)}=0$$
